...
public class GuardrailMaximumReplicationFactorTest extends ThresholdTester {
  ...
  public void testSimpleStrategyCreate() throws Throwable {
    guardrails()
        .setMaximumReplicationFactorThreshold(
            MAXIMUM_REPLICATION_FACTOR_WARN_THRESHOLD, MAXIMUM_REPLICATION_FACTOR_FAIL_THRESHOLD);
    assertWarns(
  ...
  public void testMultipleDatacenter() throws Throwable {
    ...
    List<String> twoWarnings =
        Arrays.asList(
            format(
                "The keyspace ks has a replication factor of 3, above the warning threshold of %s.",
                MAXIMUM_REPLICATION_FACTOR_WARN_THRESHOLD),
            format(
                "The keyspace ks has a replication factor of 3, above the warning threshold of %s.",
                MAXIMUM_REPLICATION_FACTOR_WARN_THRESHOLD));
    ...
    ClusterMetadataTestHelper.register(
        InetAddressAndPort.getByName("127.0.0.255"), "datacenter2", RACK1);
  ...
  public void testMaxKeyspaceRFOnlyWarnBelow() throws Throwable {
    guardrails()
        .setMaximumReplicationFactorThreshold(
            MAXIMUM_REPLICATION_FACTOR_WARN_THRESHOLD, DISABLED_GUARDRAIL);
    assertMaxThresholdValid(
        "CREATE KEYSPACE ks WITH replication = { 'class': 'NetworkTopologyStrategy', 'datacenter1':"
            + " 2}");
    assertMaxThresholdValid(
  ...
  public void testMaxKeyspaceRFOnlyFailBelow() throws Throwable {
    guardrails()
        .setMaximumReplicationFactorThreshold(
            DISABLED_GUARDRAIL, MAXIMUM_REPLICATION_FACTOR_FAIL_THRESHOLD);
    assertMaxThresholdValid(
        "CREATE KEYSPACE ks WITH replication = { 'class': 'NetworkTopologyStrategy', 'datacenter1':"
            + " 2}");
    assertMaxThresholdValid(
  ...
  public void testMaxRFLesserThanDefaultRF() {
    ...
    Assertions.assertThatThrownBy(() -> guardrails().setMaximumReplicationFactorThreshold(1, 2))
        ...
        .hasMessageContaining(
            "maximum_replication_factor_fail_threshold to be set (2) cannot be lesser than"
    ...
    Assertions.assertThatThrownBy(() -> DatabaseDescriptor.setDefaultKeyspaceRF(3))
        .isInstanceOf(IllegalArgumentException.class)
        .hasMessageContaining(
            "default_keyspace_rf to be set (3) cannot be greater than"
  ...
  private void assertWarns(String query, int rf) throws Throwable {
    assertWarns(
        query,
        format(
            "The keyspace ks has a replication factor of %d, above the warning threshold of %s.",
  ...
  private void assertFails(String query, int rf) throws Throwable {
    assertFails(
        query,
        format(
            "The keyspace ks has a replication factor of %d, above the failure threshold of %s.",
