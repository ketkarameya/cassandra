...
public class WritetimeOrTTLTest extends CQLTester {
  ...
  public void testSimple() throws Throwable {
    ...
    execute(
        "UPDATE %s USING TIMESTAMP ? AND TTL ? SET v=8 WHERE pk=1 AND ck=2", TIMESTAMP_2, TTL_1);
  ...
  public void testFrozenList() throws Throwable {
    ...
    // truncate, since previous columns would win on reconcilliation because of their TTL
    // (CASSANDRA-14592)
    execute("TRUNCATE TABLE %s");
    ...
    // Add a new element to the list with a new timestamp and a TTL
    execute(
        "INSERT INTO %s (k, v) VALUES (1, [1, 2, 3]) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_2, TTL_2);
  ...
  public void testFrozenSet() throws Throwable {
    ...
    // Add a new element to the set with a new timestamp and a TTL
    execute(
        "INSERT INTO %s (k, s) VALUES (1, {1, 2}) USING TIMESTAMP ? AND TTL ?", TIMESTAMP_2, TTL_2);
  ...
  public void testFrozenMap() throws Throwable {
    ...
    // Add a new element to the map with a new timestamp and a TTL
    execute(
        "INSERT INTO %s (k, m) VALUES (1, {1:10, 2:20}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_2, TTL_2);
  ...
  public void testNestedCollections() throws Throwable {
    ...
    execute(
        "INSERT INTO %s (k, v) VALUES (1, {1:{1,2}}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_1, TTL_1);
    execute(
        "UPDATE %s USING TIMESTAMP ? AND TTL ? SET v=v+{2:{1, 2}} WHERE k=1", TIMESTAMP_2, TTL_2);
  ...
  public void testFrozenNestedCollections() throws Throwable {
    ...
    execute(
        "INSERT INTO %s (k, v) VALUES (1, {1:{1,2}, 2:{1,2}}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_1, TTL_1);
  ...
  public void testUDT() throws Throwable {
    ...
    execute(
        "INSERT INTO %s (k, t) VALUES (0, {f1:null, f2:null}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_1, TTL_1);
    ...
    assertRows(
        "SELECT k, WRITETIME(t.f1), WRITETIME(t.f2) FROM %s WHERE k=0",
        row(0, NO_TIMESTAMP, NO_TIMESTAMP));

    // Only the first field is set
    execute(
        "INSERT INTO %s (k, t) VALUES (1, {f1:1, f2:null}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_1, TTL_1);
    ...
    assertRows(
        "SELECT k, WRITETIME(t.f1), WRITETIME(t.f2) FROM %s WHERE k=1",
        row(1, TIMESTAMP_1, NO_TIMESTAMP));
    assertRows(
        "SELECT k, WRITETIME(t.f2), WRITETIME(t.f1) FROM %s WHERE k=1",
        row(1, NO_TIMESTAMP, TIMESTAMP_1));

    // Only the second field is set
    execute(
        "INSERT INTO %s (k, t) VALUES (2, {f1:null, f2:2}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_1, TTL_1);
    ...
    assertRows(
        "SELECT k, WRITETIME(t.f1), WRITETIME(t.f2) FROM %s WHERE k=2",
        row(2, NO_TIMESTAMP, TIMESTAMP_1));
    assertRows(
        "SELECT k, WRITETIME(t.f2), WRITETIME(t.f1) FROM %s WHERE k=2",
        row(2, TIMESTAMP_1, NO_TIMESTAMP));

    // Both fields are set
    execute(
        "INSERT INTO %s (k, t) VALUES (3, {f1:1, f2:2}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_1, TTL_1);
    ...
    assertRows(
        "SELECT k, WRITETIME(t.f1), WRITETIME(t.f2) FROM %s WHERE k=3",
        row(3, TIMESTAMP_1, TIMESTAMP_1));
    ...
    assertRows(
        "SELECT k, WRITETIME(t.f1), WRITETIME(t.f2) FROM %s WHERE k=1",
        row(1, TIMESTAMP_1, TIMESTAMP_2));
    assertRows(
        "SELECT k, WRITETIME(t.f2), WRITETIME(t.f1) FROM %s WHERE k=1",
        row(1, TIMESTAMP_2, TIMESTAMP_1));
    ...
    assertRows(
        "SELECT k, WRITETIME(t.f1), WRITETIME(t.f2) FROM %s WHERE k=2",
        row(2, TIMESTAMP_2, TIMESTAMP_1));
    assertRows(
        "SELECT k, WRITETIME(t.f2), WRITETIME(t.f1) FROM %s WHERE k=2",
        row(2, TIMESTAMP_1, TIMESTAMP_2));
  }
  ...
  public void testNestedUDTs() throws Throwable {
    ...
    // Both fields are empty
    execute(
        "INSERT INTO %s (k, t) VALUES (1, {f1:null, f2:null}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_1, TTL_1);
    ...
    execute(
        "INSERT INTO %s (k, t) VALUES (2, {f1:{f1:null,f2:null}, f2:null}) USING TIMESTAMP ? AND"
            + " TTL ?",
        TIMESTAMP_1, TTL_1);
    ...
    execute(
        "INSERT INTO %s (k, t) VALUES (3, {f1:{f1:1,f2:null}, f2:null}) USING TIMESTAMP ? AND TTL"
            + " ?",
        TIMESTAMP_1, TTL_1);
    assertWritetimeAndTTL("t", "k=2", timestamps(TIMESTAMP_1, NO_TIMESTAMP), ttls(TTL_1, NO_TTL));
    assertWritetimeAndTTL("t.f1", "k=3", TIMESTAMP_1, TTL_1);
    ...
    execute(
        "INSERT INTO %s (k, t) VALUES (4, {f1:{f1:null,f2:2}, f2:null}) USING TIMESTAMP ? AND TTL"
            + " ?",
        TIMESTAMP_1, TTL_1);
    ...
    execute(
        "INSERT INTO %s (k, t) VALUES (5, {f1:{f1:1,f2:2}, f2:null}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_1, TTL_1);
    ...
    execute(
        "INSERT INTO %s (k, t) VALUES (6, {f1:null, f2:{f1:null,f2:null}}) USING TIMESTAMP ? AND"
            + " TTL ?",
        TIMESTAMP_1, TTL_1);
    ...
    execute(
        "INSERT INTO %s (k, t) VALUES (7, {f1:null, f2:{f1:1,f2:null}}) USING TIMESTAMP ? AND TTL"
            + " ?",
        TIMESTAMP_1, TTL_1);
    ...
    execute(
        "INSERT INTO %s (k, t) VALUES (8, {f1:null, f2:{f1:null,f2:2}}) USING TIMESTAMP ? AND TTL"
            + " ?",
        TIMESTAMP_1, TTL_1);
    ...
    execute(
        "INSERT INTO %s (k, t) VALUES (9, {f1:null, f2:{f1:1,f2:2}}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_1, TTL_1);
    ...
    execute(
        "INSERT INTO %s (k, t) VALUES (10, {f1:{f1:1}}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_1, TTL_1);
    ...
    // Both fields are set, alternate fields are set
    execute(
        "INSERT INTO %s (k, t) VALUES (11, {f1:{f2:2}}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_1, TTL_1);
    ...
    execute(
        "INSERT INTO %s (k, t) VALUES (12, {f1:{f1:1,f2:2}}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_1, TTL_1);
    execute(
        "UPDATE %s USING TIMESTAMP ? AND TTL ? SET t.f2={f1:1,f2:2} WHERE k=12",
        TIMESTAMP_2, TTL_2);
  ...
  public void testFrozenNestedUDTs() throws Throwable {
    ...
    // Both fields are set, alternate fields are set
    execute(
        "INSERT INTO %s (k, t) VALUES (10, {f1:{f1:1}, f2:{f2:2}}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_1, TTL_1);
    ...
    // Both fields are set, alternate fields are set
    execute(
        "INSERT INTO %s (k, t) VALUES (11, {f1:{f2:2}, f2:{f1:1}}) USING TIMESTAMP ? AND TTL ?",
        TIMESTAMP_1, TTL_1);
    ...
    // Both fields are set, all fields are set
    execute(
        "INSERT INTO %s (k, t) VALUES (12, {f1:{f1:1,f2:2},f2:{f1:1,f2:2}}) USING TIMESTAMP ? AND"
            + " TTL ?",
        TIMESTAMP_1, TTL_1);
  ...
  public void testFunctions() throws Throwable {
    ...
    execute(
        "INSERT INTO %s (k, v, s, fs) VALUES (0, 0, {1, 2, 3}, {1, 2, 3}) USING TIMESTAMP 1 AND TTL"
            + " 1000");
    execute(
        "INSERT INTO %s (k, v, s, fs) VALUES (1, 1, {10, 20, 30}, {10, 20, 30}) USING TIMESTAMP 10"
            + " AND TTL 1000");
  ...
  private void assertWritetimeAndTTL(String column, String where, Long timestamp, Integer ttl)
    ...
    assertRows(
        format("SELECT WRITETIME(%s), MAXWRITETIME(%s) FROM %%s %s", column, column, where),
  ...
  private void assertWritetimeAndTTL(
      String column, String where, List<Long> timestamps, List<Integer> ttls) throws Throwable {
    where = where == null ? "" : " WHERE " + where;
  ...
  private void assertInvalidPrimaryKeySelection(String column) throws Throwable {
    assertInvalidThrowMessage(
        "Cannot use selection function writetime on PRIMARY KEY part " + column,
        InvalidRequestException.class,
        format("SELECT WRITETIME(%s) FROM %%s", column));
    assertInvalidThrowMessage(
        "Cannot use selection function maxwritetime on PRIMARY KEY part " + column,
        InvalidRequestException.class,
        format("SELECT MAXWRITETIME(%s) FROM %%s", column));
    assertInvalidThrowMessage(
        "Cannot use selection function ttl on PRIMARY KEY part " + column,
        InvalidRequestException.class,
  ...
  private void assertInvalidListElementSelection(String column, String list) throws Throwable {
    String message =
        format("Element selection is only allowed on sets and maps, but %s is a list", list);
    assertInvalidThrowMessage(
        message, InvalidRequestException.class, format("SELECT WRITETIME(%s) FROM %%s", column));
    assertInvalidThrowMessage(
        message, InvalidRequestException.class, format("SELECT MAXWRITETIME(%s) FROM %%s", column));
    assertInvalidThrowMessage(
        message, InvalidRequestException.class, format("SELECT TTL(%s) FROM %%s", column));
  }

  private void assertInvalidListSliceSelection(String column, String list) throws Throwable {
    String message =
        format("Slice selection is only allowed on sets and maps, but %s is a list", list);
    assertInvalidThrowMessage(
        message, InvalidRequestException.class, format("SELECT WRITETIME(%s) FROM %%s", column));
    assertInvalidThrowMessage(
        message, InvalidRequestException.class, format("SELECT MAXWRITETIME(%s) FROM %%s", column));
