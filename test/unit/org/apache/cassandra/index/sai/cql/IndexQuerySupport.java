...
/**
 * A CQL-based test framework for simulating queries across as much of the index state space as
 * possible.
 *
 * <p>This includes, but need not be limited to...
 *
 * <p>1.) ...queries on the same data as it migrates through the write path and storage engine. 2.)
 * ...queries across all supported native data types. 3.) ...queries for all supported operators and
 * value boundaries. 4.) ...queries for varying write, update, delete, and TTL workloads. 5.)
 * ...queries across varying primary key and table structures. 6.) ...queries across static, normal,
 * and clustering column types. 7.) ...queries across various paging and limit settings.
 *
 * <p>IMPORTANT: This class is shared between the single-node SAITester based classes and the
 * multi-node distributed classes. It must not reference SAITester or CQLTester directly to avoid
 * static loading and initialisation.
 */
public class IndexQuerySupport {

  public static final List<BaseQuerySet> BASE_QUERY_SETS =
      ImmutableList.of(
          new BaseQuerySet(10, 5),
  ...
  public static final List<BaseQuerySet> COMPOSITE_PARTITION_QUERY_SETS =
      ImmutableList.of(
          new CompositePartitionQuerySet(10, 5),
  ...
  public static final List<BaseQuerySet> STATIC_QUERY_SETS =
      ImmutableList.of(
          new StaticColumnQuerySet(10, 5),
  ...
  public static void writeLifecycle(
      BaseDataModel.Executor executor, BaseDataModel dataModel, List<BaseQuerySet> sets)
      throws Throwable {
  ...
  public static void rowDeletions(
      BaseDataModel.Executor executor, BaseDataModel dataModel, List<BaseQuerySet> sets)
      throws Throwable {
    dataModel.createTables(executor);
  ...
  public static void cellDeletions(
      BaseDataModel.Executor executor, BaseDataModel dataModel, List<BaseQuerySet> sets)
      throws Throwable {
    dataModel.createTables(executor);
  ...
  private static void executeQueries(
      BaseDataModel dataModel, BaseDataModel.Executor executor, List<BaseQuerySet> sets)
      throws Throwable {
  ...
  public static class BaseQuerySet {
    ...
    void execute(BaseDataModel.Executor tester, BaseDataModel model) throws Throwable {
      ...
      query(
          tester,
          model,
          BaseDataModel.DATE_COLUMN,
          Operator.EQ,
          SimpleDateType.instance.fromString("2013-06-10"));
      query(
          tester,
          model,
          BaseDataModel.DATE_COLUMN,
      ...
      query(
          ...
          BaseDataModel.DATE_COLUMN,
          Operator.EQ,
          SimpleDateType.instance.fromString("2017-01-01"));
      query(
          tester,
          model,
          BaseDataModel.DATE_COLUMN,
          Operator.LT,
          SimpleDateType.instance.fromString("2000-01-01"));
      query(
          tester,
          model,
          BaseDataModel.DATE_COLUMN,
      ...
      query(
          tester,
          model,
          BaseDataModel.INET_COLUMN,
          Operator.EQ,
          InetAddressType.instance.fromString("170.63.206.57"));
      query(
          tester,
          model,
          BaseDataModel.INET_COLUMN,
          Operator.EQ,
          InetAddressType.instance.fromString("170.63.206.56"));
      query(
          tester,
          model,
          BaseDataModel.INET_COLUMN,
          Operator.EQ,
          InetAddressType.instance.fromString("205.204.196.65"));
      query(
          tester,
          model,
          BaseDataModel.INET_COLUMN,
          Operator.EQ,
          InetAddressType.instance.fromString("164.165.67.10"));
      query(
          tester,
          model,
          BaseDataModel.INET_COLUMN,
          Operator.EQ,
          InetAddressType.instance.fromString("204.196.242.71"));
      ...
      query(
          tester,
          model,
          BaseDataModel.TIME_COLUMN,
          Operator.EQ,
          TimeType.instance.fromString("00:43:07"));
      query(
          tester,
          model,
          BaseDataModel.TIME_COLUMN,
      ...
      query(
          ...
          BaseDataModel.TIME_COLUMN,
          Operator.EQ,
          TimeType.instance.fromString("00:15:57"));
      query(
          tester,
          model,
          BaseDataModel.TIME_COLUMN,
          Operator.LT,
          TimeType.instance.fromString("00:15:50"));
      query(
          tester,
          model,
          BaseDataModel.TIME_COLUMN,
          Operator.GT,
          TimeType.instance.fromString("01:30:45"));

      rangeQuery(
          tester,
          model,
          BaseDataModel.TIME_COLUMN,
          TimeType.instance.fromString("00:38:13"),
          TimeType.instance.fromString("00:56:07"));

      query(
          tester,
          model,
          BaseDataModel.TIMESTAMP_COLUMN,
          Operator.EQ,
      ...
      query(
          ...
          BaseDataModel.TIMESTAMP_COLUMN,
          Operator.LT,
          TimestampType.instance.fromString("2000-01-01T00:00:00"));
      query(
          tester,
          model,
          BaseDataModel.TIMESTAMP_COLUMN,
          Operator.GT,
          TimestampType.instance.fromString("2020-01-01T00:00:00"));
      ...
      query(
          tester,
          model,
          BaseDataModel.UUID_COLUMN,
          Operator.EQ,
          UUIDType.instance.fromString("e37394dc-d17b-11e8-a8d5-f2801f1b9fd1"));
      query(
          tester,
          model,
          BaseDataModel.UUID_COLUMN,
          Operator.EQ,
          UUIDType.instance.fromString("752355f8-405b-4d94-88f3-9992cda30f1e"));
      query(
          tester,
          model,
          BaseDataModel.UUID_COLUMN,
          Operator.EQ,
          UUIDType.instance.fromString("ac0aa734-d17f-11e8-a8d5-f2801f1b9fd1"));
      query(
          tester,
          model,
          BaseDataModel.UUID_COLUMN,
          Operator.EQ,
          UUIDType.instance.fromString("c6eec0b0-0eef-40e8-ac38-3a82110443e4"));
      query(
          tester,
          model,
          BaseDataModel.UUID_COLUMN,
      ...
      andQuery(
          ...
          BaseDataModel.TIMESTAMP_COLUMN,
          Operator.GTE,
          TimestampType.instance.fromString("2013-06-20T00:00:00"),
          BaseDataModel.UUID_COLUMN,
          Operator.EQ,
          UUIDType.instance.fromString("752355f8-405b-4d94-88f3-9992cda30f1e"),
          false);
      ...
      andQuery(
          ...
          BaseDataModel.TIMESTAMP_COLUMN,
          Operator.GTE,
          TimestampType.instance.fromString("2018-06-20T00:00:00"),
          BaseDataModel.TEXT_COLUMN,
          Operator.EQ,
          "Texas",
          false);
      ...
      andQuery(
          tester,
          model,
          BaseDataModel.SMALLINT_COLUMN,
          Operator.LTE,
          (short) 126,
          BaseDataModel.TINYINT_COLUMN,
          Operator.LTE,
          (byte) 9,
          false);
      ...
      andQuery(
          ...
          Operator.LTE,
          (short) 126,
          BaseDataModel.NON_INDEXED_COLUMN,
          Operator.GT,
          0,
          true);
      ...
      boolean hasSimplePartitionKey =
          !(model instanceof BaseDataModel.CompositePartitionKeyDataModel);
    ...
    void query(
      ...
      String query =
          String.format(
              BaseDataModel.SIMPLE_SELECT_TEMPLATE, BaseDataModel.ASCII_COLUMN, column, operator);
    ...
    void andQuery(
      ...
      String query =
          String.format(
              BaseDataModel.TWO_CLAUSE_AND_QUERY_TEMPLATE,
    ...
    void andQuery(
      ...
      String query =
          String.format(
              BaseDataModel.THREE_CLAUSE_AND_QUERY_TEMPLATE,
              BaseDataModel.ASCII_COLUMN,
              column1,
              operator1,
              column2,
    ...
    void rangeQuery(
        ...
        Object value2) {
      String query =
          String.format(BaseDataModel.RANGE_QUERY_TEMPLATE, BaseDataModel.ASCII_COLUMN, column);
    ...
    private void validate(
        ...
        BaseDataModel model,
        String query,
        boolean needsAllowFiltering,
        Object... values) {
      try {
        tester.counterReset();

        // The non indexed query we use to validate the indexed query results is just the very same
        // query but
        // with ALLOW FILTERING appended. It might happen that the non indexed query also requires
        // ALLOW
        ...
        int pageCount =
            (int) Math.ceil(actual.size() / (double) Math.min(actual.size(), fetchSize));
        assertThat(
            "Expected more calls to " + StorageAttachedIndexSearcher.class,
            tester.getCounter(),
            Matchers.greaterThanOrEqualTo((long) Math.max(1, pageCount)));
        ...
        if (needsAllowFiltering) {
          Assertions.assertThatThrownBy(
                  () -> model.executeIndexed(tester, query, fetchSize, values))
