...
public final class ViewMetadata implements SchemaElement {
  ...
  public ViewMetadata copy(TableMetadata newMetadata) {
    return new ViewMetadata(
        baseTableId, baseTableName, includeAllColumns, whereClause, newMetadata);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ViewMetadata)) return false;
  ...
  Optional<Difference> compare(ViewMetadata other) {
    if (!baseTableId.equals(other.baseTableId)
        || includeAllColumns != other.includeAllColumns
        || !whereClause.equals(other.whereClause)) return Optional.of(Difference.SHALLOW);
  ...
  public void appendCqlTo(CqlBuilder builder, boolean internals, boolean ifNotExists) {
    ...
    if (includeAllColumns) {
      ...
      builder.appendWithSeparators(
          metadata.allColumnsInSelectOrder(), (b, c) -> b.append(c.name), ", ");
    }
  ...
  public static class Serializer implements UDTAndFunctionsAwareMetadataSerializer<ViewMetadata> {
    ...
    public ViewMetadata deserialize(
